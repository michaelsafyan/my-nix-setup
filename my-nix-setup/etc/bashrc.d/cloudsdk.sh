...
function AddCloudSdkToPath() {
  for folder in "$HOME/Library/CloudSDK" "$HOME/Library/GoogleCloudSDK" "$HOME/cloud-sdk" "$HOME/google-cloud-sdk" "$HOME/.cloud-sdk" "$HOME/.google-cloud-sdk" "$HOME/Tools/cloud-sdk" "$HOME/Tools/google-cloud-sdk"; do
    if [ -d "$folder" ] ; then
